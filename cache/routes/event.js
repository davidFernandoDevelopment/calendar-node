...
router.post('/', [
    ...
    express_validator_1.check('start', 'Fecha de inicio es obligatorio').custom(helpers_1.isDate),
    express_validator_1.check('end', 'Fecha de finalizacion es obligatorio').custom(helpers_1.isDate),
